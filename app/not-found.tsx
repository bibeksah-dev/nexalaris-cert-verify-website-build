        ...
        <main className="flex flex-1 items-center justify-center px-4 py-8">
          <div className="w-full max-w-2xl text-center">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl sm:rounded-3xl sm:p-12">
              <div className="mb-6">
                <h1 className="mb-2 text-6xl font-bold text-[#12E8D5] sm:text-8xl">404</h1>
                <h2 className="mb-4 text-2xl font-bold text-[#F3F7FA] sm:text-3xl">Page Not Found</h2>
                <p className="text-base text-[#F3F7FA]/70 sm:text-lg">
